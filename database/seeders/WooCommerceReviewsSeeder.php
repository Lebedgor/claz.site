...
class WooCommerceReviewsSeeder extends Seeder
{
    ...
    {
        if (Article::withTrashed()->where('slug->en', 'best-product-review-plugins-for-woocommerce')->exists()) {
...
<div class="ex-card ex-card-rose"><div class="ex-card-head"><div style="display:inline-flex; align-items:center; gap:6px; background:#fff; border:1px solid #fecaca;border-radius:999px; padding:4px 10px; font-size:13px; font-weight:700; color:#b45309;"><span style="color:#f59e0b;">★</span>4.0 · 5 WordPress.org ratings · 600 installs</div><b>🎠 Consider carefully.</b></div><div style="margin-top:8px; font-size:14px; line-height:1.6;">Beautiful carousel widgets and a genuine multi-platform importer — but no free plan, reviews stored on Wiremo's servers, and an AI layer that preferentially displays positive feedback. A 14-day trial is the only way in.</div></div>

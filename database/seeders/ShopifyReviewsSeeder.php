...
<div class="ex-card ex-card-green"><b>🏆 Our pick: the default choice for most stores.</b><div style="margin-top:8px; font-size:14px; line-height:1.6;">Unlimited reviews on a free plan, one flat $15 tier with no order caps, and a 5.0★ rating from 46,800 merchants — the most-reviewed review app on Shopify.</div></div>
...
<div class="ex-card ex-card-cyan"><b>📸 Best for visual brands.</b><div style="margin-top:8px; font-size:14px; line-height:1.6;">Fashion, beauty, jewelry, food and home-decor stores that want product pages built around customer photos. Rating: 4.9★ from 9,596 reviews, 94% five-star, Built for Shopify.</div></div>
...
<div class="ex-card ex-card-orange"><b>🏢 The heaviest-hitting suite — at enterprise prices.</b><div style="margin-top:8px; font-size:14px; line-height:1.6;">Reviews, loyalty, SMS and email in one platform. Rating: 4.8★ from 4,635 reviews (92% five-star — and the loudest critics: ~3% one-star). No Built for Shopify badge.</div></div>
<p>The <b>free plan caps you at 50 orders per month</b> but includes automated review requests, email templates, sentiment and profanity filters, and on-site display. The <b>Starter plan at $15 per month</strong> unlocks photo and video reviews, Google rich snippets, Google Shopping Ads integration and the carousel widget — with a price that scales with order volume. The <b>Pro plan at $119 per month</b> adds Google Seller Ratings, custom review questions, AI summaries and smart sorting. Yotpo handles billing outside Shopify.</p>
<div class="images-block">
...
<div class="ex-card ex-card-violet"><b>✨ Standout: unlimited everything, on every tier.</b><div style="margin-top:8px; font-size:14px; line-height:1.6;">No order-based pricing anxiety anywhere in the lineup. Rating: 4.8★ from 1,149 reviews, Built for Shopify badge.</div></div>

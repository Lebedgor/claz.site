    ...
    <div class="mx-auto flex max-w-6xl items-stretch justify-between gap-4 px-4 py-1.5">
        ...
        <div class="flex items-center gap-1 sm:gap-2">
            ...
            <div x-data="{ catOpen: false }" class="relative hidden sm:block" @click.outside="catOpen = false">
                <button type="button"
                        class="inline-flex items-center gap-1.5 rounded-xl bg-linear-to-r from-indigo-600 to-violet-600 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-indigo-500/25 transition hover:shadow-indigo-500/40 hover:brightness-110"
                        @click="catOpen = !catOpen" :aria-expanded="catOpen" aria-haspopup="true" aria-controls="header-categories">
                    {{ __('site.nav.categories') }}
                    <span class="inline-flex transition-transform duration-200" :class="catOpen ? 'rotate-180' : ''">
